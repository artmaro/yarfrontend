...
function generateHtmlFile(sourceFile, targetFile) {
    gulp.src(sourceFile)
        .pipe(include())
...
function generateHtml() {
    ...
    generateHtmlFile('html/yappidays2017-talks/yappidays2017-apachedrill.html', 'yappidays2017-apachedrill.html');
    generateHtmlFile('html/yappidays2017-talks/yappidays2017-crud.html', 'yappidays2017-crud.html');
